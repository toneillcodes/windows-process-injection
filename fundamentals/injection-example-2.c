/*
* Process injection example 2: injecting calc.exe msfvenom shellcode into the current process, toggling the memory protection between RW and RWX
* shellcode: msfvenom -p windows/x64/exec CMD=calc.exe -f C EXITFUNC=thread
* compile: cl.exe injection-example-2.c  /W0
*/
#include <windows.h>
#include <stdbool.h>
#include <stdio.h>
